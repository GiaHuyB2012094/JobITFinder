...
const FormJobUpdate = memo(({ open, onClose, width ,title, val}) => {
    ...
    const [interviewProcess, setInterviewProcess] = useState(val.interviewProcess || [""]);
    const [deadlineSubmit, setDeadlineSubmit] = useState(formatDateYYYYMMDD(new Date(val.deadline)));
          ...
          <div className="flex-center my-3 gap-3 w-full">
            ...
            <div className="flex flex-col gap-3 w-full">
                ...
                <Select
                  ...
                  style={{ width: '100%', height: "43px", marginLeft: "10px",  border: "1px solid gray", borderRadius: "6px", }}
                  allowClear
            ...
            <div className="flex flex-col my-3 gap-3 overflow-y-scroll no-scrollbar max-h-[400px]">
              {benefit?.map((item, idx) => (
                  <div
                    ...
                    key={idx}>
                    <p className="text-xl font-medium text-gray-500">{idx+1}.</p>
                    <InputControl 
