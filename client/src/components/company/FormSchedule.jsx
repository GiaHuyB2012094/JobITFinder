...
const FormSchedule = ({ modalClose, applyID }) => {
  ...
  const onSubmit = async (data) => {
    ...
    console.log(applyID);
    try {
      await scheduleApply({ data, id: applyID }).unwrap();
      Swal.fire({
          ...
          <div className="my-2 flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-1 w-full px-2">
              <p className="text-base font-medium text-gray-600">
                Hình thức <span className="text-red-500 font-medium">*</span>
              </p>
              <Select
                ...
                options={interviewFormat?.map((item) => ({
                  value: item.value,
                  label: item.label,
                }))}
              />
