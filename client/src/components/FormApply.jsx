...
const FormApply = ({ companyID, post, modalClose  }) => {
    ...
    const onSubmit = async(data) => {
        ...
        try {
            ...
            // fetch api 1
            const result = await axios.post("http://localhost:3000/api/apply/upload-file",
                formData,
                {
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="my-2 w-full flex flex-col gap-2">
                    <div className="flex items-center gap-3 w-full">
                        <p className="font-medium text-indigo-400">(Nếu bạn chưa có CV, chọn tạo CV ngay) &#10142;</p>
                        <Button 
                    ...
                    <div className="flex flex-col gap-2">
                        <p className="text-gray-700 font-medium pl-2">Tải CV <span className="font-bold text-red-500 mx-1">*</span></p>
                        <div className="px-2">
                            {/* <Upload {...uploadProps}>
                    ...
                    <div className="flex flex-col">
                        <p className="text-gray-700 font-medium pl-2">Giới thiệu bản thân</p>
                        <textarea
                            rows={6}
                            value={intro}
