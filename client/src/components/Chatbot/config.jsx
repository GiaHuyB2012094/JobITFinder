...
const config = {
  ...
  initialMessages: [
    createChatBotMessage(
      `Chào bạn, tôi là ${botName}! Tôi có thể giúp gì cho bạn không? Bạn có muốn ứng tuyển vào các công ty trên ${botName}`,
      {}
    ),
  ...
  widgets: [
    {
      widgetName: "options",
      widgetFunc: (props) => <Options title="Các lựa chọn" {...props} />,
      mapStateToProps: ["messages", "companies"],
    },
    {
      widgetName: "optionsSearchCompanies",
      widgetFunc: (props) => (
        <OptionsSearchCompanies rchCompanies title="Các lựa chọn" {...props} />
      ),
    },
    {
      widgetName: "listTopCompanies",
      widgetFunc: (props) => (
        <ListTopCompanies title="Danh sách top công ty" {...props} />
      ),
    },
  ],
  ...
  customComponents: {
    ...
    userAvatar: (props) => (
      <AvatarBot avatar={userInfo.avatar || urlAvatarDefault} {...props} />
    ),
  },
};
