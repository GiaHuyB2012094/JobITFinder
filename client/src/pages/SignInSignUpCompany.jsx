  ...
  return (
    <>
      ...
      <div className="flex-center flex-col py-3 gap-2 w-full  rounded-md px-12">
        <form className="w-full flex flex-col gap-5 mr-3">
          <InputControl
            name="email"
            label="Email"
...
const Signup = () => {
  ...
  return (
    <div className="relative mt-10  px-24 py-10 w-full">
      <Image
        src={jobITImg}
        alt="mlkasdl"
      ...
      <div className="z-10 w-full z-10">
        <p className="text-2xl font-bold uppercase py-2">
          Đăng ký tài khoản nhà tuyển dụng
        </p>
        <p className=" mb-2">
          Tạo ngay tài khoản để tuyển dụng các ứng viên hàng đầu trên
          JobsITFinder
        </p>
          ...
          <form className="w-4/5 flex flex-col gap-3 z-10 bg-[rgba(240,240,240,0.4)] rounded-md px-10 py-8 backdrop-blur-sm">
            ...
            <div className="flex flex-col mt-0 w-full ml-2">
              ...
              <Select
                ...
                options={industryOfCompany?.map((industry) => ({
              ...
              {industryList.length === 0 && (
                <span className="text-xs text-red-500 mt-0.5">
                  Vui lòng chọn lĩnh vực của công ty
                </span>
              )}
            </div>
            ...
            <div className="flex flex-col mt-0 w-full ml-2">
              ...
              <Select
                ...
                options={dataSkillsOfCompany?.map((skill) => ({
                  value: skill.value,
                  label: skill.label,
                }))}
              />
              {skills.length === 0 && (
                <span className="text-xs text-red-500 mt-0.5">
                  Vui lòng chọn kỹ năng của công ty
                </span>
              )}
            </div>
            ...
            <div className="flex flex-col mt-0 w-full ml-2">
              ...
              {address === "" && (
                <span className="text-xs text-red-500 mt-0.5">
                  Vui lòng chọn trụ sở của công ty
                </span>
              )}
            </div>
          </form>
