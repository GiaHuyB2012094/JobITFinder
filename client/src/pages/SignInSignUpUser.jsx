  ...
  return (
    <div className="w-full h-screen">
      ...
      <main className="flex-center w-full h-full">
        <div className="w-[35%] relative px-5 bg-white h-full flex-center flex-col  shadow-md z-10">
          <p className="text-3xl font-bold text-indigo-500 py-1 uppercase">
            {" "}
        ...
        <div className="w-[65%] h-full bg-indigo-400 flex-center flex-col ">
          <Image
            src={imgVacancy}
            alt="img-vacancy"
          ...
          <p className="text-lg font-bold text-white">
            JobITFinder miễn phí cho tất cả mọi người, mọi nơi.
          </p>
          <p className=" text-white text-center w-4/5">
            Mọi ứng viên muốn tìm kiếm công việc phù hợp, công ty ưa thích với
            mọi lĩnh vực IT thì JobITFinder sẽ là lựa chọn tốt nhất giành cho
            bạn với nhiều tính năng mới mẻ
          </p>
          <div className="flex-center gap-5 my-3 text-white font-medium">
            {avatarComp?.map((item, idx) => (
              <div
                key={idx}
                className="w-16 h-16 bg-white flex-center flex-col p-1 rounded-lg"
              >
                <Image src={item} alt={`avatar-company-${idx}`} className="" />
              </div>
            ))}
