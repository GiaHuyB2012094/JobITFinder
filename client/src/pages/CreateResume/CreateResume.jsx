      ...
      <section className="px-8 pt-20 flex flex-col items-center gap-8">
        ...
        <div className="w-full flex gap-10 justify-between items-center">
          ...
          <ReactToPrint
            trigger={() => {
              return (
                <button className="flex items-center gap-x-1 py-2 px-4 bg-[#239ce2] rounded-md text-white outline-none border-none font-medium text-base active:translate-y-1 ">
                  Tải CV
                  <MdDownload />
                </button>
              );
